/* ============================================================================
 * MERGED APPLICATION SOURCE CODE - REFACTORED
 * ============================================================================ */
#include "main.h"
#include "adc.h"
 ...
 * (These satisfy the extern declarations in main.h)
 * ============================================================================ */
...
/* SOC to Vset Percentage Mapping Table */
            ...
            switch(gState)
            {
                ...
                case STATE_WAIT_BATTERY:
                {
                    ...
                    if (current_ui_state == UI_STATE_NORMAL) {
                        ...
                        else TM1637_DisplayNumber((uint16_t)(TARGET_VOLTAGE * 10)); 
                    }
                ...
                case STATE_CHARGING:
                    ...
                    if (Battery_IsDisconnectedOrFull()) {
